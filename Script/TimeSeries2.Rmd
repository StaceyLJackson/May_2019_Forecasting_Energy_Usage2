...
ts_week<-ts(house_week$week_total, frequency=53,start=c(2007,1))
...
##make forecasts
forecast_week <- forecast:::forecast.HoltWinters(HW_week,h=10)
...
##make forecasts
forecast_AR_week<-forecast:::forecast(AR_week,h=49)
